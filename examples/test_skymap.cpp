...
int main() {
    ...
    try {
        ...
        std::vector<StarData> stars = {
            {75234, 45.2, 12.8, 8.5, "G2", "α", "Ari"},
            {75245, 45.9, 12.1, 9.1, "K0", "β", "Ari"},
            {75256, 46.3, 12.7, 9.8, "A5", "γ", "Ari"},
            {75267, 45.5, 11.9, 10.2, "F8", "", "Ari"},
            {75278, 44.8, 12.5, 10.6, "G5", "", "Ari"},
            {75289, 46.1, 11.8, 11.1, "K2", "", "Ari"},
            {75300, 44.9, 13.0, 11.5, "M0", "", "Ari"},
            {75311, 46.5, 12.3, 12.0, "F5", "", "Ari"},
            {75322, 45.1, 11.5, 12.4, "K5", "", "Ari"},
            {75333, 46.8, 12.9, 13.0, "G8", "δ", "Ari"},
            {75344, 44.5, 12.2, 13.5, "A0", "", "Ari"},
            {75355, 46.0, 13.2, 13.8, "K8", "", "Ari"}
        };
        ...
        style.constellation_line_color = "#000000";      // Nero
        style.constellation_boundary_color = "#000000";  // Nero
        style.target_color = "#000000";                  // Nero
        style.trajectory_color = "#000000";              // Nero
        style.fov_rect_color = "#000000";                // Nero per il rettangolo tratteggiato
        style.grid_color = "#CCCCCC";                    // Grigio chiaro per la griglia
        style.show_star_labels = true;                   // Numeri SAO
        style.show_flamsteed_letters = true;             // Lettere di Flamsteed
        ...
        style.grid_dashed = true;                        // Linee tratteggiate
        ...
        if (success) {
            ...
            std::cout << "📝 Caratteristiche della mappa:" << std::endl;
            ...
            std::cout << "   ✓ Lettere di Flamsteed per le stelle principali (α, β, γ, δ)" << std::endl;
            std::cout << "   ✓ Linee asterismi della costellazione di Ariete (nero)" << std::endl;
            std::cout << "   ✓ Confini ufficiali IAU della costellazione (nero)" << std::endl;
            std::cout << "   ✓ Griglia RA/Dec ogni 5° (linee tratteggiate grigie)" << std::endl;
            std::cout << "   ✓ Asteroid 17030 evidenziato in nero" << std::endl;
            std::cout << "   ✓ Traiettoria dell'asteroide dal 26 al 29 novembre 2025 (nero)" << std::endl;
            std::cout << "   ✓ Rettangolo nero tratteggiato che indica il FOV del finder chart" << std::endl;
